...
class BruteForceEngine:
        ...
        while self._running and not self._stop_requested:
            ...
            try:
                ...
                if not self._stop_requested:
                    logger.info(f"Waiting {refresh_interval_minutes} minutes before next cycle...")
    ...
    def _test_element(self, screen_fp: str, element: InteractiveElement):
        ...
        try:
            ...
            after_path, after_base64 = self.screenshot_handler.capture_state(page, "after")
            ...
            if after_fp != screen_fp:
                ...
                if not self.site_map.is_screen_known(after_fp):
                    viewport = self.browser_manager.get_viewport_size()
                    elements = self.element_discovery.discover_elements(after_base64, viewport)
                ...
                result = "no_change"
                self.site_map.add_transition(screen_fp, element.label, screen_fp, result)
